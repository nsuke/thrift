...
if(WITH_CPP)
    ...
    CMAKE_DEPENDENT_OPTION(WITH_OPENSSL "Build with OpenSSL support" ON
                           "OPENSSL_FOUND" OFF)
    option(WITH_STDTHREADS "Build with C++ std::thread backend" OFF)
    CMAKE_DEPENDENT_OPTION(WITH_BOOSTTHREADS "Build with Boost thread backend" OFF
                           "NOT WITH_STDTHREADS;Boost_FOUND" OFF)
    CMAKE_DEPENDENT_OPTION(WITH_PTHREADS "Build with pthread backend" ON
                           "NOT WITH_STDTHREADS;NOT WITH_BOOSTTHREADS;NOT MSVC" OFF)
    if(NOT WITH_STDTHREADS AND NOT WITH_BOOSTTHREADS)
        if(MSVC)
            set(WITH_STDTHREADS ON)
        else()
...
message(STATUS "  Build with Boost thread backend:            ${WITH_BOOSTTHREADS}")
message(STATUS "  Build with C++ std::thread backend:         ${WITH_STDTHREADS}")
if(NOT MSVC)
message(STATUS "  Build with pthread backend:                 ${WITH_PTHREADS}")
endif()
